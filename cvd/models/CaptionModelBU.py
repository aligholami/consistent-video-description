...
class CaptionModel(nn.Module):
    ...
    def beam_search(self, state, rnn_output, beam_fc_feats, beam_conv_feats, beam_p_conv_feats, \
        ...
        for t in range(self.seq_length):
            ...
            # encode as vectors
            # it holds a beam tensor of size beam_size at timestep t.
            it = beam_seq[t].cuda()
            # make sure that none of the token ids is beyond the vocab size!
            ...
            # Get new rnn outputs and states, attention weights and attention hidden states
