...
def parse_opt():
    ...
    parser.add_argument('--split_file', type=str, default='cvd/tools/anet_entities/data/split_ids_anet_entities.json')
    ...
    parser.add_argument('--visdom_server', type=str, default='localhost', help='update it with your server url')
